...
#
define zabbix::userparameters_windows (
  $source     = '',
  $content    = '',
  $script     = '',
  $script_ext = '',
  ...
  $include_dir          = getvar('::zabbix::agent_windows::include_dir')
  $zabbix_package_agent = getvar('::zabbix::agent_windows::zabbix_package_agent')
  $agent_config_owner   = getvar('::zabbix::agent_windows::agent_config_owner')
  $agent_config_group   = getvar('::zabbix::agent_windows::agent_config_group')
